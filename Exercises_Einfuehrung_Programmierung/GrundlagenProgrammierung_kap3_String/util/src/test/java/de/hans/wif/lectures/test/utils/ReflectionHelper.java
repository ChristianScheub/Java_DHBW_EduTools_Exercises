...
public class ReflectionHelper {
    ...
    public static <T, R> void setProperty(Class<T> clazz, String propertyName, T instance, R newValue, boolean fail) {
        ...
        getFieldValue(clazz, propertyName, instance, fail).ifPresent(
                v -> Assert.assertEquals("Setzen des Werts mit Hilfe des Setters " + clazz.getSimpleName() + "::" + getSetterName(propertyName) + " scheint nicht zu funktionieren!",
                        newValue, v)
        );
    }
        ...
        getFieldDeclaration(clazz, fieldName, fail).ifPresent(
                f -> {
                    ...
                    for (int modifier: modifiers) {
                        Assert.assertEquals("Das Feld " + clazz.getSimpleName() + "::" + fieldName + " sollte mit dem Modifier '" + Modifier.toString(modifier) + "' versehen sein!",
                                Modifier.toString(modifier), Modifier.toString(f.getModifiers() & modifier));
                    }
                }
        );
    }
